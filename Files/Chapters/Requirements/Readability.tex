...
\begin{enumerate}
    \item \index{Base Visibility}\underline{\textsc{Base Visibility}} : Must be readable from any point by a person with \index{6/6 vision}\gls{6/6 vision} standing at upto 8 feet in front of the bus stop.
