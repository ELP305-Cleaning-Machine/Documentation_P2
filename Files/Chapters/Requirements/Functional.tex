...
\begin{enumerate}
    ...
    \item \index{U-Turn}\underline{\textsc{Bus U-Turn}} : There may not be sufficient space at every stop for the bus to make a U-turn and onboard passengers on the reverse path. Bus follows its route strictly, does not make U-Turns.
