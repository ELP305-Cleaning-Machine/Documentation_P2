...
\begin{enumerate}
    \item \index{Driver}\underline{\textsc{Driver Notification for Passenger Wait Time}} : There's no obligation to inform the driver if a passenger waits for more than a minute. Waiting time is restricted to passenger boarding and deboarding.
