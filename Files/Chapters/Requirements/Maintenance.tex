...
\begin{enumerate}
    ...
    \item \index{Display Malfunction}\underline{\textsc{Display Malfunction}} : In the event of an unforeseen malfunction in the display unit, a \gls{stall period} of 1 hour will be allowed to fix the issue.
