...
\item{
\textbf{ID:} \hypertarget{Target_DocInfo}{P2RS-\mydate-\input{ver}}\footnote{Format is [ProjectName]-[Year]-[Month]-[Day]-[Version]}
}
      \item{
      ...
      \item
            {
            \textbf{Version Number:} \hypertarget{Target_Ver}{\input{ver.tex}}\footnote{Tracked automatically in the \textbf{GitHub} Repository.
