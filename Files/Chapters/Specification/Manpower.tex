...
We used \textbf{OverLeaf} and \textbf{GitHub} to organise the project. We set up detailed \textbf{Workflows}, \textbf{Actions} and \textbf{Bots}, automating \textbf{.pdf} generation after new \textbf{Commits} and a thorough \textbf{Code-Structure} which made handing on task to others (who are unfamiliar with the \textbf{Codebase}), very smooth and also avoiding \textbf{Merge Conflicts}.
