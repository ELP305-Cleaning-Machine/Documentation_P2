...
\begin{enumerate}
    ...
    \item This unit will tell the time left for the buses from both direction to arrive at the station using the \index{sliding text animation}\textit{\gls{sliding text animation}}
